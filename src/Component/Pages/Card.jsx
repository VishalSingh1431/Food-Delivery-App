  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 w-62 flex flex-col items-center text-center transition-transform duration-300 hover:scale-105">
      ...
      <div className="mt-3 flex gap-20">
        ...
        <button className="w-25 shadow-[0px_-10px_20px_rgba(0,255,255,0.3),0px_10px_20px_rgba(255,255,255,0.3)] shadow-blue-300 p-2 rounded-3xl hover:bg-blue-300 transition duration-300">
          Add to Cart
        </button>
      </div>
    </div>
